...
Implementation update: DR-001 through DR-005 are complete. DR-002, DR-003 and DR-005 are
captured in [DESIGN-FOUNDATIONS-AUDIT.md](DESIGN-FOUNDATIONS-AUDIT.md) and
[VISUAL-REGRESSION-CHECKLIST.md](VISUAL-REGRESSION-CHECKLIST.md). DR-004 was
verified against both real product routes in Vercel Preview on 18 September
2026. DR-006 (Maison Neue licence/removal) remains open. The isolated DR-1 and
component review route is in progress; no broad migration has started.
